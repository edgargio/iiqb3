...
<div class="well well-sm"> <h4><b>Gestión de préstamo de vehículo</b></h4> </div>
		 ...
		 <div class="panel-body">  
				...
				<!-- --------------------------------------- -->
					...
					<!-- 
 					...
 					<?= Html::a('Préstamo', ['site/vehiculoprestamodet'], ['class'=>'btn btn-primary grid-button btn-xs']) ?>

 					<?= Html::a('Gestion interna', ['site/vehiculoentrega'], ['class'=>'btn btn-primary grid-button btn-xs']) ?>
